...
namespace ZParse.Tests.Tokenizers;
...
public class TokenizerBuilderTests
{
    ...
    public void SExpressionsCanBeTokenized()
    {
        var tokenizer = new TokenizerBuilder<SExpressionToken>()
            ...
            .Match(
                Character.Letter.IgnoreThen(Character.LetterOrDigit.AtLeastOnce()),
                SExpressionToken.Atom,
    ...
    public void PartiallyFailedTokenizationIsReported()
    {
        ...
        Assert.Equal(
            "Syntax error (line 1, column 2): invalid abc, unexpected `d`, expected `c` at line 1, column 4.",
            msg
        );
    }
    ...
    public void ShortTokenizationIsReported()
    {
        ...
        var msg = tokens.ToString();
        Assert.Equal(
            "Syntax error (line 1, column 2): incomplete abc, unexpected end of input, expected `c`.",
            msg
        );
    }
