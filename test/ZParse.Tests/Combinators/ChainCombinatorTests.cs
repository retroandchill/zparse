...
public class ChainCombinatorTests
{
    ...
    public void SuccessWithLongChains()
    {
        ...
        var input = string.Join("+", Enumerable.Repeat("1", chainLength));
    ...
    public void SuccessLeftAssociativeChain()
    {
        ...
        var seed = Character
            .EqualTo('A')
            .Select(_ => System.Collections.Immutable.ImmutableList.Create<int>());
        ...
        AssertParser.SucceedsWith(
            chainParser,
            input,
            System.Collections.Immutable.ImmutableList.Create(1, 2, 3)
        );
    }
}
