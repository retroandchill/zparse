...
public class ApplyCombinatorTests
{
    ...
    public void AnAppliedParserIsNotCalledIfThePrecedingParseFails()
    {
        ...
        Assert.False(result.HasValue);
        Assert.Equal(
            "Syntax error (line 1, column 1): unexpected `1`, expected `aa`.",
            result.ToString()
        );
    }
    ...
    public void AnAppliedParserMustConsumeTheWholeTokenSpan()
    {
        ...
        Assert.Equal(
            "Syntax error (line 1, column 1): invalid a, unexpected `a`.",
            result.ToString()
        );
    }
    ...
    public void AFailingAppliedParserDoesNotCauseBacktracking()
    {
        ...
        Assert.False(result.HasValue);
        Assert.Equal(
            "Syntax error (line 1, column 1): unexpected `a`, expected digit.",
            result.ToString()
        );
    }
    ...
    public void AFailingAppliedParserDoesNotCauseTokenBacktracking1()
    {
        ...
        Assert.Equal(
            "Syntax error (line 1, column 2): incomplete a, expected `b`.",
            result.ToString()
        );
    }
    ...
    public void AFailingAppliedParserDoesNotCauseTokenBacktracking2()
    {
        ...
        // this would read more like "invalid URI: expected `:`".
        Assert.Equal(
            "Syntax error (line 1, column 1): invalid a, unexpected `a`, expected `b`.",
            result.ToString()
        );
    }
}
